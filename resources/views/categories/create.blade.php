...
@section('titulo', getenv('CTF_NAME')." - Criar Categoria")
@section('conteudo')
    ...
    <form class="form-horizontal" role="form" method="POST" action="{{route('categoriasCreate')}}">
        ...
        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="nome" type="text" class="form-control input" name="name" value="{{ old('name') }}" required
                       autofocus placeholder="Nome da categoria..." onchange="tituloAlter()">
                @if ($errors->has('nome'))
        ...
        <div class="form-group{{ $errors->has('color') ? ' has-error' : '' }}">
            ...
            <div class="col-md-1">
                <input id="color" type="color" class="form-control input" name="color" value="{{ old('color') }}"
        ...
        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <textarea class="form-control input" name="description" id="descricao"
                          onchange="descAlter()">{{ old('description') }}</textarea>
    ...
    <div class="row">
        <div class="col-md-offset-4 col-md-3 col-lg-3">
            <div class="box-users" style="cursor:pointer;background-color:#f1f1f120" id='box-categoria'
                 data-toggle="modal" data-target="#teste" style="color:#fff;cursor:pointer" id='novoTitulo'>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form>
                        ...
                        <button type="button" class="button button-black" data-dismiss="modal"
                                value="">@lang('categories.close')</button>
                    </form>
                </div>
            </div>
        </div>
