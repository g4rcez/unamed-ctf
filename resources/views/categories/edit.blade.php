...
@section('conteudo')
    ...
    <div class="espacos"></div>
    <form class="form-horizontal" role="form" method="POST" action="{{url("/categorias/editar/$categoria->nome/$categoria->id")}}">
        {{ csrf_field() }}
        <div class="form-group{{ $errors->has('nome') ? ' has-error' : '' }}">
            <label for="nickname" class="col-md-4 control-label">Nome da Categoria: </label>
            <div class="col-md-6">
                <input id="nome" type="text" class="form-control input" name="nome" value="{{ $categoria->nome }}" required autofocus placeholder="Nome da categoria...">
                @if ($errors->has('nome'))
        ...
        <div class="form-group{{ $errors->has('descricao') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <textarea class="form-control input" name="descricao" id="descricao">{{ $categoria->descricao }}</textarea>
